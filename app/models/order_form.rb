class OrderForm
  ...
  def save
    ...
    Payment.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, street_address: street_address, building: building, tell: tell, order_id: order.id)
  end
end