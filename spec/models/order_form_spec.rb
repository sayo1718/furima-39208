  ...
  describe '配送先情報の保存' do
    context '配送先情報の保存ができるとき' do
      ...
      it '電話番号が11番桁以内かつハイフンなしであれば保存できる' do
        @order_form.tell = 12_345_678_910
        expect(@order_form).to be_valid
      end
    end
    ...
    context '配送先情報の保存ができないとき' do
      ...
      it '電話番号にハイフンがあると保存できないこと' do
        ...
        @order_form.valid?
        expect(@order_form.errors.full_messages).to include("Tell is invalid. Include hyphen(-)")
      end
      ...
      it '電話番号が9桁以下と保存できないこと' do
        @order_form.tell = '12_345_678_9'
        @order_form.valid?
        expect(@order_form.errors.full_messages).to include("Tell is invalid. Include hyphen(-)")
      end
      it '電話番号が全角だと保存できないこと' do
        @order_form.tell = '１２３−４５６７−８９０１'
        @order_form.valid?
        expect(@order_form.errors.full_messages).to include("Tell is invalid. Include hyphen(-)")
      end
